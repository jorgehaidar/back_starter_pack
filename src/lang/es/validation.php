...
return [
    ...
    | modificar cada uno de estos mensajes según tus necesidades.
    |
    */
    ...
    'password' => [
        ...
        'length' => 'El campo :attribute debe tener al menos 8 caracteres.',
    ],
    ...
    | especificar rápidamente un mensaje personalizado para una regla de atributo.
    |
    */
    ...
    | posición de atributo con algo más amigable como "Dirección de correo"
    | en lugar de "email". Esto simplemente nos ayuda a hacer el mensaje
    | más expresivo.
    |
    */
